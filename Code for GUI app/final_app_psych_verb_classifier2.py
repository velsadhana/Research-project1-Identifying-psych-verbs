...
lbl1=tk.Label(master=frame1, text="Enter the sentence",bg="#CCD1D1",fg="black",font=('Lucida Calligraphy',20,'bold'))
lbl1.grid(row=2, column=0, padx=10, pady=10)

# textbox for displaying the sentence
path_txtbx1 = tk.Entry(master=frame1, font=('aerial',20),bg="#F2F3F4")
path_txtbx1.grid(row=2, column=1, padx=10, pady=10)

# label2 'Enter verb position'
lbl2=tk.Label(master=frame1, text="Enter verb position",bg="#CCD1D1",fg="black",font=('Lucida Calligraphy',20,'bold'))
lbl2.grid(row=3, column=0, padx=10, pady=10)

# textbox for displaying the verb position
path_txtbx2 = tk.Entry(master=frame1, font=('aerial',20),bg="#F2F3F4")
path_txtbx2.grid(row=3, column=1, padx=10, pady=10)


# big text box for displaying the result
acc_txt_bx = tk.Entry(master=frame1,font=('calibri',25),bg="#F2F3F4",fg="red")
acc_txt_bx.grid(row=5, column=2, padx=10, pady=10)
...
def get_model():
    psych_model = tf.keras.models.load_model('C:\SadhanaOldlaptop\Velsadhana\Masterscourse\Linguistics Data Science\Sum sem 2022\Research project 1\Model\model1.h5',compile=False)
...
upld_btn4.grid(row=4, column=2, padx=10, pady=10)

lbl3=tk.Label(master=frame1, text="Psych verbs identifier",bg="#CCD1D1",fg="blue",font=('Calibri',30,'bold'))
